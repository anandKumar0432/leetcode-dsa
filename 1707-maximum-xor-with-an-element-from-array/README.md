<h2><a href="https://leetcode.com/problems/maximum-xor-with-an-element-from-array/?utm=codolio">1826. Maximum XOR With an Element From Array</a></h2><h3>Hard</h3><hr><p>You are given an array <code>nums</code> consisting of non-negative integers. You are also given a <code>queries</code> array, where <code>queries[i] = [x<sub>i</sub>, m<sub>i</sub>]</code>.</p>
